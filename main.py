...
from game_classes import Game, text_font, title, Button, ingame_title, volume, settings_volume_text
...
return_button = Button(25, 25, 150, 50, "Return", "#ff4c4c")
volumeup_button = Button(350, 140, 50, 50, "+", "#20f79d")
volumedown_button = Button(400, 140, 50, 50, "-", "#ff4c4c")
...
while running:
    ...
    if gamestate == "settings":
        ...
        screen.blit(settings_volume_text, (200, 150))
